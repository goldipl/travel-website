...
export const HeroText = () => {
  return (
    <div className='absolute regular-14 max-container top-1/3 z-1 xl:w-3/6 bg-indigo-100/[.15] p-4 rounded-3xl xl:left-[12%] lg:left-[7%] md:left-[7%] lg:w-4/6 md:w-4/5 sm:left-[3%]'>
